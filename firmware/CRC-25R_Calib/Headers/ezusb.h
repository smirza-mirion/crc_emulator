...
extern CONFIGDSCR*	EZUSB_GetConfigDscr(BYTE ConfigIdx);
extern INTRFCDSCR*	EZUSB_GetIntrfcDscr(BYTE ConfigIdx, BYTE IntrfcIdx, BYTE AltSetting);
extern STRINGDSCR*	EZUSB_GetStringDscr(BYTE StrIdx);
extern DSCR*		EZUSB_GetDscr(BYTE index, DSCR* dscr, BYTE type);

extern void EZUSB_InitI2C(void);
extern BOOL EZUSB_WriteI2C_(BYTE addr, BYTE length, BYTE *dat);
extern BOOL EZUSB_ReadI2C_(BYTE addr, BYTE length, BYTE *dat);
extern BOOL EZUSB_WriteI2C(BYTE addr, BYTE length, BYTE *dat);
extern BOOL EZUSB_ReadI2C(BYTE addr, BYTE length, BYTE *dat);
