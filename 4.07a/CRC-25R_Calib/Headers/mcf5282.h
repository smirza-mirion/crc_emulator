...
#define MCF5282_FEC_MDATA		(*(vuint32  *)(void *)(&__IPSBAR[0x1040]))
...
#define MCF5282_FLEXCAN_MBUF0_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C0080]))
...
#define MCF5282_FLEXCAN_MBUF1_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C0090]))
...
#define MCF5282_FLEXCAN_MBUF2_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00A0]))
...
#define MCF5282_FLEXCAN_MBUF3_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00B0]))
...
#define MCF5282_FLEXCAN_MBUF4_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00C0]))
...
#define MCF5282_FLEXCAN_MBUF5_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00D0]))
...
#define MCF5282_FLEXCAN_MBUF6_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00E0]))
...
#define MCF5282_FLEXCAN_MBUF7_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C00F0]))
...
#define MCF5282_FLEXCAN_MBUF8_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C0100]))
...
#define MCF5282_FLEXCAN_MBUF9_CTRL	(*(vuint16 *)(void *)(&__IPSBAR[0x1C0110]))
...
#define MCF5282_FLEXCAN_MBUF10_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0120]))
...
#define MCF5282_FLEXCAN_MBUF11_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0130]))
...
#define MCF5282_FLEXCAN_MBUF12_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0140]))
...
#define MCF5282_FLEXCAN_MBUF13_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0150]))
...
#define MCF5282_FLEXCAN_MBUF14_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0160]))
...
#define MCF5282_FLEXCAN_MBUF15_CTRL		(*(vuint16 *)(void *)(&__IPSBAR[0x1C0170]))
...
/*********************************************************************
*
* Power Management Module (PPM)
*
*********************************************************************/

/* Read/Write access macros for general use */
#define MCF5282_PPM_LPICR		(*(vuint8  *)(void *)(&__IPSBAR[0x000012]))
#define MCF5282_PPM_LPCR		(*(vuint8  *)(void *)(&__IPSBAR[0x110007]))

/* Bit level definitions and macros */
#define MCF5282_PPM_LPICR_ENBSTOP			(0x80)
#define MCF5282_PPM_LPICR_XSTOP_IPL(x)		(((x)&0x07)<<4)

#define MCF5282_PPM_LPCR_LPMD_STOP			(0xC0)
#define MCF5282_PPM_LPCR_LPMD_WAIT			(0x80)
#define MCF5282_PPM_LPCR_LPMD_DOZE			(0x40)
#define MCF5282_PPM_LPCR_LPMD_RUN			(0x00)

#define MCF5282_PPM_LPCR_STMD_00			(0x00)
#define MCF5282_PPM_LPCR_STMD_01			(0x08)
#define MCF5282_PPM_LPCR_STMD_10			(0x10)
#define MCF5282_PPM_LPCR_STMD_11			(0x18)

#define MCF5282_PPM_LPCR_LVDSE				(0x02)
/********************************************************************/
