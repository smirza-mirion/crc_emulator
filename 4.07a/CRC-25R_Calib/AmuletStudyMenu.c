...
void AmuletStudy_menu(void) {
	switch(m_iPhase) {
		...
		case PHASE_STUDY_HIDA:
			m_iAddInventory_Study = 2;
			SetAmuletBackHTML();
			break;

		case PHASE_STUDY_HEART:
			m_iAddInventory_Study = 3;
			SetAmuletBackHTML();
			break;

		case PHASE_STUDY_RENAL:
			m_iAddInventory_Study = 4;
			SetAmuletBackHTML();
			break;

		case PHASE_STUDY_LIVER:
			m_iAddInventory_Study = 5;
			SetAmuletBackHTML();
			break;

		case PHASE_STUDY_BRAIN:
			m_iAddInventory_Study = 6;
			SetAmuletBackHTML();
			break;

		case PHASE_STUDY_LYMPH:
			m_iAddInventory_Study = 7;
			SetAmuletBackHTML();
			break;
