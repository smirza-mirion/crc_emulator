/**
 * \file
 * \details This file contains functions, which calls either the SPI layer or the SD Card layer and implements the FAT filesystem.
 */
/*----------------------------------------------------------------------------/
...
#include "../../Headers/ff.h"			/* FatFs configurations and declarations */
#include "../../Headers/diskio.h"		/* Declarations of low level disk I/O functions */
...
)
{
	...
	if ((LD_DWORD(&fs->win[BS_FilSysType]) & 0xFFFFFF) == 0x544146){
		fs->serial_number = LD_DWORD(&fs->win[BS_VolID32]);
		return 0;
	}
...
/*-----------------------------------------------------------------------*/
/**
 * \details Mount/Unmount a Logical Drive
...
/*-----------------------------------------------------------------------*/
/**
 * \details Synchronize the File Object
 * \param fp Pointer to the file object
 * \returns Status code
 */
FRESULT f_sync (
...
/**
 * \details Change Current Directory
...
#if _FS_RPATH >= 2
/**
 * \details Get Current Working Directory
 * \param path Pointer to the directory path
...
/*-----------------------------------------------------------------------*/
/**
 * \details Create a Directory Object
...
/*-----------------------------------------------------------------------*/
/**
 * \details Read Directory Entry in Sequence
...
/*-----------------------------------------------------------------------*/
/**
 * \details Get Number of Free Clusters
...
/*-----------------------------------------------------------------------*/
/**
 * \details Delete a File or Directory
